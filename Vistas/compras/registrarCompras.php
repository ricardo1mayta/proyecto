          ...
          function(){
            setTimeout(function(){
                          ...
                          $.ajax({
                                 type: "POST",
                                 url: url,
                                 data: {idemp: idemp, u:us,t:t,num:num,ar:optionArr,s:s}, // Adjuntar los campos del formulario enviado.
                    ...
                    <div class="panel panel-default  ">
                      ...
                      <div class="panel-body">
                        <div class="col-md-12">
                          ...
                          <div class=" col-md-4">
                            <div class="form-group">
                                <input id="numerodoc" name="" type="text"  class="form-control " placeholder="Numero Doc" autofocus>
                            </div>
                          </div>
                        </div>
