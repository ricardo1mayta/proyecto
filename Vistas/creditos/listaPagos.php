                       ...
                       $result=$p->get_pagosv($idcre);
                        ...
                        $total=$total+ $lista[2];                   
                           ...
                           <tr id="sell<?=$lista[0]?>" >
                             ...
                             <td><?php echo "S/. ".$lista[2] ?></td>
                             <td><?php echo $lista[3] ?></td>
                             <td><?php echo $lista[5] ?></td>
                             <td><?php if ($lista[6]!=""){ ?> <a href="" data-toggle="modal" data-target="#imgviewmodal" data-img="<?=$lista[6]?>"   data-toggle="tooltip" title="IMAGEN">Ver Comprobante de pago</a>
                             <?php } else{
